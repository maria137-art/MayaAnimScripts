...
def toggle_scriptEditor():
	...
	script_editor = cmds.window("scriptEditorPanel1Window", query=True, exists=True)
	
	if script_editor:
		mel.eval("toggleWindowVisibility scriptEditorPanel1Window;")
	else:
		cmds.tearOffPanel("Script Editor", "scriptEditor", True)
